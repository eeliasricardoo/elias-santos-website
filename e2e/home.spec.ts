...
test.describe('Home Page', () => {
  test('should load the home page successfully', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { level: 1 })).toContainText('UX From the Future')
  ...
  test('should display hero section correctly', async ({ page }) => {
    ...
    await expect(page.getByText('Strategic UX/UI Designer & Full Stack Developer. I transform complex business challenges into elegant, user-centered solutions that drive measurable results and accelerate time-to-market.')).toBeVisible()
  ...
  test('should have proper meta tags', async ({ page }) => {
    ...
    await expect(metaDescription).toHaveAttribute('content', /Professional portfolio/)
