...
describe('HeroContent', () => {
  ...
  it('should render the description text', () => {
    ...
    const description = screen.getByText(/Strategic UX\/UI Designer & Full Stack Developer/)
    expect(description).toBeInTheDocument()
    expect(description).toHaveClass('text-xl', 'md:text-2xl', 'text-muted-foreground')
  })
