        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              MVP de chatbot inteligente desenvolvido em 5 dias. Validação de mercado em tempo recorde 
              com resultados impressionantes e 93% de redução de custos.
            </p>
              ...
              <div className="relative w-full">
                <div style={{padding:'56.25% 0 0 0',position:'relative'}}>
                  ...
                  >
                    ...
                    <source src="/case destaque/new_recording_-_7_18_2025,_5_39_16_pm (1080p).mp4" type="video/mp4" />
                  </video>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Uma jornada completa de concepção, desenvolvimento e otimização de uma plataforma de chat com IA
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-foreground">Problema Identificado</h3>
              <p className="text-muted-foreground">
                Falta de uma solução unificada para chat com IA, custos elevados de modelos premium e experiências fragmentadas.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-foreground">Solução Proposta</h3>
              <p className="text-muted-foreground">
                Plataforma única que integra múltiplos modelos de IA, otimiza custos e oferece experiência fluida.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Desenvolvedores, criadores de conteúdo, estudantes e profissionais que buscam produtividade.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                  <div className="text-center space-y-4 p-8">
                    ...
                    <div className="space-y-2">
                      <h4 className="text-white font-bold text-lg">Comece uma nova conversa</h4>
                      <p className="text-gray-300 text-sm">Digite sua mensagem abaixo para começar a conversar com a IA</p>
                    </div>
                  </div>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent pointer-events-none" />
                <div className="absolute bottom-4 left-4 right-4">
                  <Badge className="bg-yellow-500/20 text-yellow-500 border-yellow-500/30 mb-2">Versão 0</Badge>
                  <h4 className="text-white font-bold text-lg mb-2">Conceito Inicial</h4>
                  <p className="text-white/90 text-sm">Interface básica com funcionalidade essencial</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative overflow-hidden rounded-2xl shadow-2xl border border-border/30 bg-card/90 group-hover:shadow-3xl transition-all duration-500">
                <div className="aspect-video bg-gradient-to-br from-gray-900 to-blue-900 flex">
                  <div className="w-1/4 bg-gray-800 p-4">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="w-full h-8 bg-blue-800 rounded text-white text-sm flex items-center px-3">Quem é pedro?</div>
                        <div className="w-full h-8 bg-gray-700 rounded text-gray-300 text-sm flex items-center px-3">esquece</div>
                      </div>
                    </div>
                  </div>
                  <div className="flex-1 p-4">
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="bg-gray-700 rounded px-3 py-1 text-white text-sm">Claude 3.5 Sonnet</div>
                      </div>
                      <div className="bg-blue-800 rounded-lg p-4 text-white text-sm">
                        <p>Pedro é um nome muito comum e pode se referir a várias pessoas famosas...</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent pointer-events-none" />
                <div className="absolute bottom-4 left-4 right-4">
                  <Badge className="bg-green-500/20 text-green-500 border-green-500/30 mb-2">Versão 2.1</Badge>
                  <h4 className="text-white font-bold text-lg mb-2">Gemini Cli Melhorado</h4>
                  <p className="text-white/90 text-sm">Interface aprimorada com sidebar e conversas</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative overflow-hidden rounded-2xl shadow-2xl border border-border/30 bg-card/90 group-hover:shadow-3xl transition-all duration-500">
                <div className="aspect-video bg-gradient-to-br from-gray-900 to-purple-900 flex">
                  <div className="w-1/4 bg-gray-800 p-4">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="w-full h-8 bg-purple-800 rounded text-white text-sm flex items-center px-3">o que você ve?</div>
                        <div className="w-full h-8 bg-gray-700 rounded text-gray-300 text-sm flex items-center px-3">esquece</div>
                      </div>
                      <div className="absolute bottom-4 left-4 right-4">
                        <div className="bg-gray-700 rounded p-2 flex items-center gap-2">
                          <div className="w-6 h-6 bg-purple-600 rounded text-white text-xs flex items-center justify-center">ES</div>
                          <div className="text-white text-xs">
                            <div>Elias Santos</div>
                            <div className="text-gray-400">eeliasricardoo@gmail.com</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex-1 p-4">
                    <div className="space-y-4">
                      ...
                      <div className="bg-gray-700 rounded-lg p-4">
                        ...
                        <p className="text-white text-sm">Esta é a logomarca do Google em sua versão mais moderna...</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent pointer-events-none" />
                <div className="absolute bottom-4 left-4 right-4">
                  <Badge className="bg-blue-500/20 text-blue-500 border-blue-500/30 mb-2">Versão Final</Badge>
                  <h4 className="text-white font-bold text-lg mb-2">Design Completo</h4>
                  <p className="text-white/90 text-sm">Interface final com análise de imagens</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="text-center space-y-6">
              <h4 className="text-2xl font-bold text-foreground">A Evolução do Design</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Comecei o projeto com uma interface básica, focando apenas na funcionalidade essencial do chat com IA.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h5 className="font-semibold text-foreground">Gemini Cli</h5>
                  </div>
                  <p className="text-muted-foreground text-sm">
                    Pedi para o Gemini Cli melhorar o design, que adicionou sidebar, histórico de conversas e melhor organização.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h5 className="font-semibold text-foreground">Versão Final</h5>
                  </div>
                  <p className="text-muted-foreground text-sm">
                    Interface completa com análise de imagens, perfil do usuário e todas as funcionalidades avançadas implementadas.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-muted/30 via-background to-muted/20">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Design moderno e intuitivo que oferece uma experiência fluida de conversação com IA
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/30 bg-card/90 group-hover:shadow-3xl transition-all duration-500">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  <h3 className="text-2xl font-bold text-white mb-2">Interface Principal</h3>
                  <p className="text-white/90">Chat limpo e organizado com histórico de conversas</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/30 bg-card/90 group-hover:shadow-3xl transition-all duration-500">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  <h3 className="text-2xl font-bold text-white mb-2">Sistema de Login</h3>
                  <p className="text-white/90">Autenticação segura com Supabase</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/30 bg-card/90 group-hover:shadow-3xl transition-all duration-500">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  <h3 className="text-2xl font-bold text-white mb-2">Menu Lateral</h3>
                  <p className="text-white/90">Navegação intuitiva entre conversas</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/30 bg-card/90 group-hover:shadow-3xl transition-all duration-500">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  <h3 className="text-xl font-bold text-white mb-2">Interface Compacta</h3>
                  <p className="text-white/90">Design responsivo para diferentes telas</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/30 bg-card/90 group-hover:shadow-3xl transition-all duration-500">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  <h3 className="text-xl font-bold text-white mb-2">Modelos Personalizados</h3>
                  <p className="text-white/90">Escolha entre diferentes modelos de IA</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/30 bg-gradient-to-br from-primary/10 via-background to-primary/5 p-12 group-hover:shadow-3xl transition-all duration-500">
                ...
                <div className="relative z-10 text-center space-y-8">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-3xl font-bold text-foreground">Funcionalidades Avançadas</h3>
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                      Geração de imagens, vídeos, múltiplos modelos de IA e muito mais integrados em uma única plataforma
                    </p>
                  </div>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          >
            <div className="text-center space-y-4">
              <h3 className="text-3xl md:text-4xl font-bold text-foreground">Sistema de Componentes</h3>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Biblioteca de componentes reutilizáveis baseada em Shadcn/ui e Radix UI
              </p>
            </div>
          ...
          >
            <div className="text-center space-y-4">
              <h3 className="text-3xl md:text-4xl font-bold text-foreground">Sistema de Cores</h3>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {[
                { name: "Background", class: "bg-background", color: "bg-gray-100 dark:bg-gray-900" },
                { name: "Foreground", class: "bg-foreground", color: "bg-gray-900 dark:bg-gray-100" },
                { name: "Primary", class: "bg-primary", color: "bg-blue-600" },
                { name: "Secondary", class: "bg-secondary", color: "bg-gray-200 dark:bg-gray-800" },
                { name: "Muted", class: "bg-muted", color: "bg-gray-100 dark:bg-gray-800" },
                { name: "Border", class: "bg-border", color: "bg-gray-300 dark:bg-gray-700" }
              ].map((color, index) => (
                <motion.div
                  key={color.name}
                  initial={{ opacity: 0, scale: 0.9 }}
                ...
                >
                  <div className={`w-16 h-16 rounded-xl mx-auto border border-border/20 ${color.color}`} />
                  <div>
          ...
          >
            <div className="text-center space-y-4">
              <h3 className="text-3xl md:text-4xl font-bold text-foreground">Sistema de Tipografia</h3>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            ...
            <div className="bg-card/60 border border-border/20 rounded-2xl p-8 space-y-6">
              <div className="space-y-2">
                <h1 className="text-4xl md:text-5xl font-bold text-foreground">Heading 1 - Título Principal</h1>
                <p className="text-sm text-muted-foreground">text-4xl md:text-5xl font-bold</p>
              </div>
              <div className="space-y-2">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground">Heading 2 - Subtítulo</h2>
                <p className="text-sm text-muted-foreground">text-3xl md:text-4xl font-bold</p>
              </div>
              <div className="space-y-2">
                <h3 className="text-2xl font-bold text-foreground">Heading 3 - Seção</h3>
                <p className="text-sm text-muted-foreground">text-2xl font-bold</p>
              </div>
              <div className="space-y-2">
                <p className="text-lg text-foreground">Body Large - Texto de destaque</p>
                <p className="text-sm text-muted-foreground">text-lg</p>
              </div>
              <div className="space-y-2">
                <p className="text-base text-foreground">Body - Texto padrão do sistema</p>
                <p className="text-sm text-muted-foreground">text-base</p>
              </div>
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">Body Small - Texto secundário</p>
          ...
          >
            <div className="text-center space-y-4">
              <h3 className="text-3xl md:text-4xl font-bold text-foreground">Processo de UX</h3>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              ...
              {[
                {
                  step: "01",
                  title: "Discovery",
                  description: "Análise de usuários, pesquisa de mercado e definição de problemas",
                  icon: Target
                },
                {
                  step: "02",
                  title: "Design",
                  description: "Wireframes, protótipos e design system baseado em insights",
                  icon: Palette
                },
                {
                  step: "03",
                  title: "Development",
                  description: "Implementação ágil com feedback contínuo e testes",
                  icon: Code
                },
                {
                  step: "04",
                  title: "Validation",
                  description: "Testes de usabilidade, métricas e iteração baseada em dados",
                  icon: TrendingUp
                }
              ].map((phase, index) => (
                <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-foreground">Velocidade de Desenvolvimento</h3>
              </div>
              
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">Tempo de Desenvolvimento</span>
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-foreground">Satisfação do Usuário</h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">Conversas Processadas</span>
                  <span className="font-bold text-foreground">10.000+</span>
                </div>
                <div className="border-t border-border/20 pt-4">
                  <div className="flex justify-between items-center">
                    <span className="text-green-500 font-bold">Redução de Tempo</span>
            ...
            {[
              {
                ...
                solution: "Implementação de sistema híbrido com localStorage como fallback",
                result: "Sincronização automática e migração transparente de dados"
              },
              {
                title: "Integração de APIs",
                problem: "Coordenação complexa entre múltiplas APIs de IA",
                solution: "Sistema unificado com fallback e tratamento de erros robusto",
                result: "Interface fluida com múltiplos modelos de IA integrados"
              },
              {
                title: "Performance e Cache",
                problem: "Latência alta nas requisições de IA",
                solution: "Sistema de cache inteligente e otimizações de queries",
              ...
              <motion.div
                ...
                className="bg-card/80 border border-border/20 rounded-xl p-8"
              >
                <h3 className="text-2xl font-bold text-foreground mb-6">{challenge.title}</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <h4 className="font-semibold text-red-500 mb-2">❌ Problema</h4>
                    <p className="text-muted-foreground">{challenge.problem}</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-blue-500 mb-2">💡 Solução</h4>
                    <p className="text-muted-foreground">{challenge.solution}</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-green-500 mb-2">✅ Resultado</h4>
