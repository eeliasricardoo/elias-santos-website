      ...
      <main className='max-w-4xl mx-auto py-12 px-4 space-y-20 pt-24'>
        ...
        <section className='space-y-8'>
          ...
          >
            ...
            <div className='space-y-6 text-lg text-muted-foreground leading-relaxed'>
              <p>
                To structure my work and ensure I was not only building the
                right product, but also building the product the right way, I
                adopted the principles of the{' '}
                <strong className='text-foreground'>Double Diamond</strong>{' '}
                design model. I adapted its phases to fit an intense one-week
                sprint, focusing on converging and diverging rapidly.
              </p>
            </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='bg-primary/5 border border-primary/20 rounded-lg p-6'>
                  ...
                  <p className='text-muted-foreground'>
                    No tool offered granular control over models or was
                    optimized for a multimodal workflow (text, image, code)
                    without imposing a subscription cost or complex interface.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className='bg-card border border-border/20 rounded-xl p-6 space-y-4'>
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  <div className='space-y-2'>
                    ...
                    <p className='text-muted-foreground'>
                      Accelerate the development and experimentation cycle
                      without worrying about costs or platform limitations.
                    </p>
                  </div>
                  <div className='space-y-2'>
                    <h4 className='font-semibold text-foreground flex items-center'>
        ...
        <section className='space-y-8'>
          ...
          >
                ...
                <div className='bg-card border border-border/20 rounded-xl p-6'>
                  ...
                  <div className='grid md:grid-cols-2 gap-6'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Chosen as a &quot;backend-in-a-box&quot;. The trade-off
                        of giving up granular infrastructure control was a
                        conscious decision to enable delivery in one week.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className='bg-card border border-border/20 rounded-xl p-6'>
                  ...
                  <div className='space-y-4'>
                    <div className='space-y-2'>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Organization was fundamental. From the start, I
                        structured the project modularly and defined a simple
                        but rigorous Design System based on Shadcn/UI and
                        TailwindCSS.
                      </p>
                    </div>
                    <div className='space-y-2'>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Performance wasn&apos;t a late optimization, but a
                        design requirement. This manifested in the choice of
                        React.memo, virtual scrolling implementation, and
            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-4'>
                <p className='text-lg text-muted-foreground'>
                  With design and architecture defined, I dove into
                  construction, following the evolution I mapped:
                </p>
          ...
          >
            ...
            <div className='space-y-6 text-lg text-muted-foreground leading-relaxed'>
              <p>
                ...
                development universe. ChatAI is not just a product case;
                it&apos;s proof of my work philosophy.
              </p>
            </div>
            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-4'>
                <div className='bg-card border border-border/20 rounded-xl p-6 space-y-4'>
                  ...
                  <p className='text-muted-foreground'>
                    Even informal application of a process like Double Diamond
                    is a force multiplier. Investing time in Discovery and
                    Definition saved me from building wrong features and allowed
                    the Development phase to be extremely focused.
                  </p>
                </div>
                ...
                <div className='bg-card border border-border/20 rounded-xl p-6 space-y-4'>
                  ...
                  <p className='text-muted-foreground'>
                    The obsession with clean code and organized architecture
                    from Day 1 proved to be an accelerator, not a brake. It was
                    this solid foundation that allowed me to add complex
                    features like video generation mid-week without breaking the
                    system or needing major refactoring.
                  </p>
                </div>
              </div>
            </div>
