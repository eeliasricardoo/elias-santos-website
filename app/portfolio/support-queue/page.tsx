		...
		<>
			...
			<main className='max-w-4xl mx-auto py-12 px-4 space-y-20 pt-24'>
				...
				<section className='space-y-6'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>1. Overview</h2>
				...
				{/* 2. Project context */}
				<section className='space-y-6'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>2. Project context</h2>
					<ul className='list-disc pl-6 space-y-2 text-muted-foreground'>
						<li>
				...
				{/* 3. Problem */}
				<section className='space-y-6'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>3. Problem</h2>
				...
				<section className='space-y-4'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>4. Goal</h2>
					<p className='text-lg text-muted-foreground leading-relaxed'>
				...
				{/* 5. Design hypothesis */}
				<section className='space-y-4'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>5. Design hypothesis</h2>
					<p className='text-lg text-muted-foreground leading-relaxed'>
				...
				{/* 6. UX process */}
				<section className='space-y-6'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>6. UX process</h2>
				...
				{/* 7. Final solution */}
				<section className='space-y-6'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>7. Final solution</h2>
					<ol className='list-decimal pl-6 space-y-2 text-muted-foreground'>
				...
				{/* 8. Moderated test */}
				<section className='space-y-4'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>8. Moderated test</h2>
					<ul className='list-disc pl-6 space-y-2 text-muted-foreground'>
						<li>
				...
				<section className='space-y-4'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>9. Acceptance criteria</h2>
					<ol className='list-decimal pl-6 space-y-2 text-muted-foreground'>
				...
				<section className='space-y-6'>
					<h2 className='text-3xl md:text-4xl font-bold text-foreground'>10. Results & how we validated</h2>
