...
- **[Melhorias de Qualidade](./CODE_QUALITY_IMPROVEMENTS.md)** - Documentação
  completa das melhorias implementadas
- **[Guia de Desenvolvimento](./DEVELOPMENT_GUIDE.md)** - Guia prático para usar
...
- **[Notas de Redesign](../REDESIGN_NOTES.md)** - Notas sobre o processo de
  redesign
...
1. **Leia o [Guia de Desenvolvimento](./DEVELOPMENT_GUIDE.md)** - Instruções
   práticas
2. **Consulte as [Melhorias de Qualidade](./CODE_QUALITY_IMPROVEMENTS.md)** -
   Contexto das mudanças
3. **Siga as [Regras do Design System](../DESIGN_SYSTEM_RULES.md)** - Padrões
   visuais
