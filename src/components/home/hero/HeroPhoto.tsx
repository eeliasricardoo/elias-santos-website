    ...
    >
      ...
      <div className="relative w-[400px] h-[500px] rounded-2xl overflow-hidden border border-border/40 group">
        ...
        <picture>
          ...
          <source
            srcSet="/optimized/profile-photo-640w.webp 640w, /optimized/profile-photo-750w.webp 750w, /optimized/profile-photo-828w.webp 828w, /optimized/profile-photo-1080w.webp 1080w, /optimized/profile-photo-1200w.webp 1200w, /optimized/profile-photo-1920w.webp 1920w"
      ...
      <div className="absolute -right-5 top-1/4 h-1/2 w-px bg-gradient-to-b from-transparent via-brand-violet/30 to-transparent" />
      {/* Decorative horizontal line */}
      <div className="absolute -bottom-5 left-1/4 w-1/2 h-px bg-gradient-to-r from-transparent via-brand-cyan/30 to-transparent" />
    </motion.div>
  );
}
