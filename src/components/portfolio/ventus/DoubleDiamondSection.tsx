...
export function DoubleDiamondSection() {
  return (
    <CaseStudySection title="My Process: A Sprint in Double Diamond" className="text-center">
      <div className='bg-primary/5 border border-primary/10 rounded-xl p-8 mb-12 text-left md:text-center text-muted-foreground'>
