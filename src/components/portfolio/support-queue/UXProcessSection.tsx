    ...
    <section className='space-y-8'>
      ...
      >
        ...
        <div className='space-y-6 text-lg text-muted-foreground leading-relaxed'>
          <p>
            Our UX process focused on{' '}
            <strong className='text-foreground'>
              iterative development and continuous validation
            </strong>
            , ensuring that each design decision was backed by research and user
            feedback.
          </p>
        </div>
            ...
            <div className='space-y-6'>
              <div className='bg-card/80 p-6 rounded-lg border border-border/20'>
                ...
                <ul className='space-y-2 text-muted-foreground text-sm'>
                  <li>
                    <strong>User:</strong> online agents (Attendant+ profile)
                  </li>
                  <li>
                    <strong>Trigger:</strong> ≥1 ticket and agent under
                    active‑chat limit
                  </li>
                  <li>
                    <strong>Content:</strong> title, queue counter, waiting
                    time, Accept CTA
                  </li>
                  <li>
                    <strong>Actions:</strong> Accept (primary), Ignore,
                    &quot;x&quot; close
                  </li>
                </ul>
              </div>
              ...
              <div className='bg-card/80 p-6 rounded-lg border border-border/20'>
                ...
                <ul className='space-y-2 text-muted-foreground text-sm'>
                  <li>
                    <strong>Optimistic lock:</strong> prevents double assignment
                  </li>
                  <li>
                    <strong>Expiration:</strong> pop‑up expires in 15 seconds
                  </li>
                  <li>
                    <strong>Limit:</strong> maximum 3 pending pop‑ups
                  </li>
                  <li>
                    <strong>Performance:</strong> appears in &lt; 500ms
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className='space-y-6'>
              <div className='bg-card/80 p-6 rounded-lg border border-border/20'>
                ...
                <ul className='space-y-2 text-muted-foreground text-sm'>
                  ...
                  <li>
                    • Clicking Accept assigns the ticket and opens the
                    conversation
                  </li>
          ...
          <div className='mt-8 p-6 bg-background rounded-lg border border-border/20'>
            ...
            <div className='space-y-4'>
              <blockquote className='italic text-muted-foreground border-l-4 border-primary pl-4'>
                &quot;The blue button helps, but &apos;Ignore&apos; should be
                less prominent.&quot;
              </blockquote>
              <p className='text-sm text-muted-foreground'>
                <strong>Implemented change:</strong> Reduced the visual
                prominence of the &quot;Ignore&quot; button to emphasize the
