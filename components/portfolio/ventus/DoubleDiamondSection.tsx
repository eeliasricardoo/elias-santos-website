...
import { Eye, Target, Code, Rocket, Lightbulb, Zap, CheckCircle } from 'lucide-react';
        ...
        <div className='relative max-w-4xl mx-auto'>
          <div className='grid grid-cols-4 gap-4 items-center'>
            ...
            >
              ...
              <p className='text-sm text-muted-foreground'>Competitive analysis, user research, problem identification</p>
            </motion.div>
            ...
            >
              ...
              <p className='text-sm text-muted-foreground'>Problem definition, user personas, journey mapping</p>
            </motion.div>
            ...
            >
              ...
              <p className='text-sm text-muted-foreground'>Prototyping, technical architecture, rapid iteration</p>
            </motion.div>
            ...
            >
              ...
              <p className='text-sm text-muted-foreground'>Production deployment, testing, optimization</p>
            </motion.div>
          </div>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-6 mt-12'>
          <div className='bg-card border border-border/20 rounded-xl p-6 space-y-4'>
            <div className='flex items-center space-x-3'>
              ...
              <h4 className='font-semibold text-foreground'>Structured Thinking</h4>
            </div>
          ...
          <div className='bg-card border border-border/20 rounded-xl p-6 space-y-4'>
            <div className='flex items-center space-x-3'>
              ...
              <h4 className='font-semibold text-foreground'>Rapid Convergence</h4>
            </div>
            <p className='text-sm text-muted-foreground'>
