            ...
            <div className='bg-muted/5 rounded-xl p-4 sm:p-6 border border-border/10'>
              ...
              <div className='mb-6'>
                ...
                <p className='leading-relaxed text-sm sm:text-base'>
                  ...
                  user-centered digital products for enterprise and
                  international clients across Brazil, Bolivia, Ecuador, and
                  Colombia. Specialized in leading end-to-end design processes
                  from research and wireframing to prototyping and front-end
                  implementation. Strong background in product strategy,
                  AI-integrated UX, accessibility (ADA best practices), and
                  KPI-driven design. Proven success in collaborating
                  cross-functionally in agile teams to build high-impact,
                  scalable, and inclusive digital solutions.
                </p>
              </div>
                      ...
                      <div className='flex-1'>
                        ...
                        <ul className='space-y-2 text-sm'>
                          ...
                          <li className='flex items-start gap-2'>
                            <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                            <span>
                              Developed an AI platform integrating
                      ...
                      <div className='flex-1'>
                        ...
                        <div className='space-y-2'>
                          ...
                          <div className='flex items-start gap-2'>
                            <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                            <span className='text-sm'>
                              UX/UI & Prototype: Estação hack from Facebook -
                              Mar 2021
                            </span>
                          </div>
                          <div className='flex items-start gap-2'>
                          ...
                          <div className='flex items-start gap-2'>
                            <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                            <span className='text-sm'>
                              UX Design Patterns with Checklist Design - Aug
                              2024
                            </span>
                          </div>
                          <div className='flex items-start gap-2'>
