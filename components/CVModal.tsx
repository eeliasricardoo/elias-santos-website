          ...
          <div className='bg-muted/5 rounded-xl p-4 sm:p-6 border border-border/10'>
            ...
            <div className='mb-6'>
              ...
              <p className='leading-relaxed text-sm sm:text-base'>
                UX/UI Designer with 4+ years of experience in designing
                user-centered digital products for enterprise and international
                clients across Brazil, Bolivia, Ecuador, and Colombia.
                Specialized in leading end-to-end design processes from research
                and wireframing to prototyping and front-end implementation.
                Strong background in product strategy, AI-integrated UX,
                accessibility (ADA best practices), and KPI-driven design.
                Proven success in collaborating cross-functionally in agile
                teams to build high-impact, scalable, and inclusive digital
                solutions.
              </p>
            </div>
                    ...
                    <div className='flex-1'>
                      ...
                      <ul className='space-y-2 text-sm'>
                        <li className='flex items-start gap-2'>
                          ...
                          <span>
                            Led the design team on a corporate LMS platform
                            project
                          </span>
                        </li>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Developed an AI platform integrating text-to-image,
                            text completion, image-to-video, and speech-to-text
                            technologies
                          </span>
                        </li>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Created a mobile app with over 500 active users,
                        ...
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Conducted UX research with stakeholders from large
                            enterprises
                          </span>
                        </li>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Implemented responsive front-end interfaces using
                        ...
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Worked in an agile environment with Scrum
                            methodology
                          </span>
                        </li>
                      </ul>
                    ...
                    <div className='flex-1'>
                      ...
                      <ul className='space-y-2 text-sm'>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Migrated the OLIVER Spain website to the Latin
                            America version
                          </span>
                        </li>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Adapted content and structure for Portuguese and
                        ...
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Resolved complex WordPress technical challenges
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className='flex-1'>
                      ...
                      <ul className='space-y-2 text-sm'>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Mapped full website HTML for Google Tag Manager
                            implementation
                          </span>
                        </li>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Configured Google Analytics 4 (GA4) integration
                          </span>
                        </li>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Implemented advanced data tracking for digital
                    ...
                    <div className='flex-1'>
                      ...
                      <ul className='space-y-2 text-sm'>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Led website redesign proposal for Zurich Brazil
                          </span>
                        </li>
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                        ...
                        <li className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span>
                            Created wireframes and interactive prototypes using
                            Figma
                          </span>
                        </li>
                      </ul>
                  ...
                  <div className='flex items-start gap-3'>
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='text-sm mb-1'>
                        Bachelor in Service Design (In progress)
                      </p>
                    ...
                    <div className='flex-1'>
                      ...
                      <div className='space-y-2'>
                        ...
                        <div className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span className='text-sm'>
                            UX/UI & Prototype: Estação hack from Facebook - Mar
                            2021
                          </span>
                        </div>
                        <div className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span className='text-sm'>
                            JavaScript para Web: Crie páginas dinâmicas - Nov
                            2022
                          </span>
                        </div>
                        <div className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span className='text-sm'>
                            UX Design Patterns with Checklist Design - Aug 2024
                          </span>
                        </div>
                        <div className='flex items-start gap-2'>
                          <div className='w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                          <span className='text-sm'>
                            (More than 40 courses in Web Design, Front-end
                            Development, and UX Research)
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='flex-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          Figma, Wireframing, Prototyping, UX Research, Design
                          Systems, Accessibility (WCAG), Heuristic Evaluation
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='flex-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          React, Next.js, Tailwind CSS, Shadcn UI, TypeScript,
                          HTML/CSS, Framer, WordPress, FlutterFlow, Notion,
                          Draw.io
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='flex-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          Design Thinking, Double Diamond, Lean UX, Agile,
                          Scrum, Service Design
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='flex-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          Text-to-Image, Text Completion, Image-to-Video,
                          Speech-to-Text (OpenAI, Replicate, etc.)
                        </p>
                      </div>
                    </div>
                  </div>
